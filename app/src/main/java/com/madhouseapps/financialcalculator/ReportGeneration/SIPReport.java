...
public class SIPReport extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void askForPermission(){
        ...
        if (ContextCompat.checkSelfPermission(getApplicationContext(),
            ...
            if (file != null) {
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT, "This SIP Report was generated Using FinCal https://play.google.com/store/apps/details?id=com.madhouseapps.financialcalculator");
                shareIntent.setType("image/*");
                // Launch sharing dialog for image
                startActivity(Intent.createChooser(shareIntent, "Share Image"));
                Toast.makeText(this, "SIP Report Saved To The Device.", Toast.LENGTH_SHORT).show();
                finish();
